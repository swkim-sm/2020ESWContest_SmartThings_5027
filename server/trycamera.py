...
while True:
    ...
    if not mask_loop_end:
        ...
        cv2.putText(frame, "Put your face in the middle", (0, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (255, 255, 0) , 2)
    ...
    if mask_loop_end and not motion_loop_end:
        cv2.putText(frame, "Mark the actuator number with your finger.", (0, 30),
        ...
        if motion_flag:
            if not motion_loop:
                ...
                during = time.time() - start
                cv2.putText(frame, str(during), (500, 500), cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,255,0), 2)
                if during > 2:
                    motion_loop = False
    ...
    # -------- | ROI 영역 그리기 | ----------------------------------------------------------
    frame = cv2.rectangle(frame, (10, 100), (600, 700), (255, 255, 0), 3)
    frame = cv2.putText(frame, "Face", (10, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (255, 255, 0), 2)
    #frame = cv2.rectangle(frame, (10, 300), (330, 700), (255, 255, 0), 3)
    frame = cv2.rectangle(frame, (670, 300), (990, 700), (255, 255, 0), 3)
    frame = cv2.putText(frame, "Hand", (670, 280), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (255, 255, 0), 2)
    #frame = cv2.putText(frame, "Press 'R' to try again.", (0, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.9,(0, 255, 0), 2)
